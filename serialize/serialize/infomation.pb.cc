...
// source: serialize/infomation.proto

#include "serialize/infomation.pb.h"
...
static ::_pb::Metadata file_level_metadata_serialize_2finfomation_2eproto[1];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_serialize_2finfomation_2eproto[2];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_serialize_2finfomation_2eproto = nullptr;

const uint32_t TableStruct_serialize_2finfomation_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_serialize_2finfomation_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\032serialize/infomation.proto\"\235\001\n\013Informa"
  ...
  "resCode\030\007 \001(\0162\r.ResponseCode*\314\001\n\013Request"
  ...
  "therPlayHand\020\t\022\022\n\016OtherLeaveRoom\020\n\022\n\n\006Fa"
  "iled\020\013b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_serialize_2finfomation_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_serialize_2finfomation_2eproto = {
    false, false, 614, descriptor_table_protodef_serialize_2finfomation_2eproto,
    "serialize/infomation.proto",
    &descriptor_table_serialize_2finfomation_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_serialize_2finfomation_2eproto::offsets,
    file_level_metadata_serialize_2finfomation_2eproto, file_level_enum_descriptors_serialize_2finfomation_2eproto,
    file_level_service_descriptors_serialize_2finfomation_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_serialize_2finfomation_2eproto_getter() {
  return &descriptor_table_serialize_2finfomation_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_serialize_2finfomation_2eproto(&descriptor_table_serialize_2finfomation_2eproto);
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* RequestCode_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_serialize_2finfomation_2eproto);
  return file_level_enum_descriptors_serialize_2finfomation_2eproto[0];
}
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ResponseCode_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_serialize_2finfomation_2eproto);
  return file_level_enum_descriptors_serialize_2finfomation_2eproto[1];
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Information::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_serialize_2finfomation_2eproto_getter, &descriptor_table_serialize_2finfomation_2eproto_once,
      file_level_metadata_serialize_2finfomation_2eproto[0]);
}
